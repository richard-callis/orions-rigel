    ...
    <div className="flex-1">
      <section className="mx-auto max-w-4xl px-4 pt-20 pb-16 text-center">
        ...
        <div className="flex items-center justify-center gap-3">
          <Link
            href="/courses"
            className="rounded-md bg-accent text-white px-5 py-2.5 text-sm font-medium hover:opacity-90 transition-opacity"
          >
            Browse courses
          </Link>
          <Link
            href="/signup"
            className="rounded-md border border-border px-5 py-2.5 text-sm font-medium hover:bg-black/5 dark:hover:bg-white/5 transition-colors"
          >
            Create an account
          </Link>
        </div>
      ...
      {courses.length > 0 && (
        <section className="mx-auto max-w-4xl px-4 pb-24">
          <h2 className="text-xl font-semibold tracking-tight mb-4">Courses</h2>
